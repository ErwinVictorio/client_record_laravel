...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ...
            'middle_name' => 'M',
            'NickName' => 'Jane',
            'role' => '0', // Binago ko ang role ginawa kong '2' para maiba sa Admin
            'username' => 'superAdmin',
            'department' => 'superAdmin', // Pwede mo rin itong palitan ng 'Treasury' o 'Finance' depende sa tawag sa inyo
