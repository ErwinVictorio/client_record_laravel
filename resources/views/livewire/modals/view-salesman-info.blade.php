        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">{{$completeName}}</h1>
                          ...
                          <div class="card h-100 shadow-sm border-0">
                              ...
                              <div class="card-body">
                                  <ul class="list-unstyled text-muted mb-0">
                                      <li><strong>Name:</strong> {{$completeName}}</li>
                                      <li><strong>Department:</strong> {{$salesmanInfo->department}}</li>
                                      <li><strong>Username:</strong> {{$salesmanInfo->username}}</li>
                                  </ul>
                              </div>
                          </div>
                      </div>
                          ...
                          <div class="card h-100 shadow-sm border-0">
                              ...
                              <div class="card-body">
                                  <div class="row g-3">
                                      <!-- Total Sold -->
                                      <div class="col-md-6">
                                          <div class="p-3 border rounded bg-success bg-opacity-10 text-success text-center">
                                              <h6 class="mb-1">
                                      ...
                                      <!-- Total Pending -->
                                      <div class="col-md-6">
                                          <div class="p-3 border rounded bg-warning bg-opacity-10 text-warning text-center">
                                              <h6 class="mb-1">
