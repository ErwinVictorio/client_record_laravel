        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h1 class="modal-title fs-5" id="staticBackdropLabel">
              <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="#004998" class="bi bi-pen" viewBox="0 0 16 16">
          ...
          <div class="modal-body">
             <form wire:submit='update_clientInfo'>
                          ...
                          <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                              <div class="form-floating mb-3">
                                  ...
                                  <label for="bank_Account_number">Bank Account Number(opptional)</label>
                                </div>
                            </div>
                </section>
