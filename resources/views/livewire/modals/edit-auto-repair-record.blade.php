<div wire:ignore.self class="modal fade" id="AutoRepair_{{$recordId}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
      <div class="modal-content border-0 shadow-lg">
        ...
        <div class="modal-body bg-light p-4">
          <form wire:submit.prevent='updateAutoRepair'>
            <section class="row g-3 bg-white border rounded-3 p-3 p-md-4 shadow-sm">
              <h6 class="fw-bold mb-0">Client & Stock-out Information</h6>
            ...
            <div class="modal-footer bg-white mx-n4 mb-n4 mt-4 px-4">
              ...
              <button style="background-color: #004998" type="submit" class="btn text-light px-4" wire:loading.attr="disabled" wire:target="updateAutoRepair">
                <span wire:loading wire:target="updateAutoRepair" class="spinner-border spinner-border-sm me-1"></span>
