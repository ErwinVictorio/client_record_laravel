                ...
                <form wire:submit.prevent="change_status">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            @if (count($existing_supporting_document_paths) > 0)
                                <div class="small text-muted mb-2">
                                    ...
                                    @foreach ($existing_supporting_document_paths as $path)
                                        <span class="badge bg-light text-dark border me-1">{{ basename($path) }}</span>
                                    @endforeach
                                </div>
                            @endif
                            ...
                            {{-- General File Requirement Error --}}
                            @error('supporting_docs')
                                <span class="text-danger small d-block fw-bold mb-2">{{ $message }}</span>
                            @enderror

                            <div wire:loading wire:target="supporting_docs" class="text-primary small mb-2">
                            ...
                            <div class="border rounded p-2 mb-2" wire:key="status-vehicle-{{ $clientId }}-{{ $index }}">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @error("vehicles.$index.mast_type_selection") <span class="text-danger small d-block mt-1">{{ $message }}</span> @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @error("vehicles.$index.tire_selection") <span class="text-danger small d-block mt-1">{{ $message }}</span> @enderror
                                        @if (($vehicle['tire_selection'] ?? '') === 'Other')
                                            ...
                                            @error("vehicles.$index.tire_other") <span class="text-danger small d-block mt-1">{{ $message }}</span> @enderror
                                        @endif
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn text-light" style="background-color: #004998" wire:loading.attr="disabled" wire:target="supporting_docs,change_status">
                            <span wire:loading wire:target="change_status" class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>
                            Submit (提交)
                        </button>
                    </div>
                </form>
