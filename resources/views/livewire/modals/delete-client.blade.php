<div>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <form wire:submit.prevent="destroyClient">
                    <div class="modal-body px-4 py-4">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-3" id="deleteClientModalDescription_{{ $clientId }}">
                    ...
                    <div class="modal-footer border-0 bg-light px-4 py-3">
                        ...
                        <button type="submit" class="btn btn-danger" wire:loading.attr="disabled" wire:target="destroyClient">
    ...
    @script
    <script>
        $wire.on('hide-delete-client-modal', () => {
            const modalElement = document.getElementById('deleteClientModal_{{ $clientId }}');
