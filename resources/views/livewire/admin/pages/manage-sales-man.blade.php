<div>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="/admin/dashboard">Dashbaord</a>
        <!-- Sidebar Toggle-->
                        ...
                        <div class="card-body">
                            ...
                            @foreach ($salesman as $user)
                                <livewire:modals.view-salesman-info
                                    :salesmanID="$user->id"
                                    :wire:key="'admin-view-salesman-info-'.$user->id"
                                />
                                <livewire:modals.edit-salesman
                                    :salesmanID="$user->id"
                                    :wire:key="'admin-edit-salesman-'.$user->id"
                                />
                                <livewire:modals.delete-salesman
                                    :salesmanID="$user->id"
                                    :wire:key="'admin-delete-salesman-'.$user->id"
                                />
                            @endforeach
                        </div>
                    </div>
