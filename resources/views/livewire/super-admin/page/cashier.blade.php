<div class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{route('superAdminDashboard.view')}}">Cashier Dashboard</a>
        <!-- Sidebar Toggle-->
                            ...
                            <div class="card text-white shadow bg-danger rounded-4 h-100 border-0">
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            <h6 class="text-uppercase fw-semibold mb-1">Total For Approval Clients</h6>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <livewire:modals.client-info
                                :clientId="$client->id"
                                :wire:key="'super-admin-cashier-client-info-'.$client->id"
                            />
                            @endforeach
                            {{$clientList->links()}}
                        </div>
