<div class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="/superAdmin/Dashboard">Dashboard</a>
        <!-- Sidebar Toggle-->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <span style="{{$color}}" class="badge rounded-pill text-white px-3 py-2">
                                            {{ $client->status .' / '. $Sold}}
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button data-bs-toggle="modal"
                                            data-bs-target="#viewClientDetails_{{$client->id}}"
                                            style="background-color: #004998" class="btn text-light rounded-0">
                                        ...
                                        <button data-bs-target="#EditClientIfo_{{$client->id}}"
                                            wire:key="'edit-info-'.$client->id " data-bs-toggle="modal"
                                            class="btn text-light rounded-0" style="background-color: #004998">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <button class="btn btn-outline-danger rounded-0" data-bs-toggle="modal"
                                ...
                                <livewire:modals.view-client-details :clientId="$client->id"
                                    :wire:key="'view-client-'.$client->id" />

                                {{-- for Editing the Client Information --}}
                                <livewire:modals.edit-client-info-for-admin :clientId="$client->id"
                                    :wire:key=" 'edit-client-info-'.$client->id " />
                                @endforeach
